...
import MainDeliveryModal from '../../components/MainDeliveryModal'
        ...
        <MapView
         ...
         {showRider && (
          <RiderModal
           ...
           cancelRequestButton={handleCancelRequest}
           arriveButton={handleArrive}
          ...
          <View>
            <DeliveryAction
             visible={showDeliveryAction}
             startDeliveryButton={handleShowDelivery}
             cancelDeliveryButton={handleCancelRequest}
          ...
          <MainDeliveryModal
           ...
           goToChatPage={goToChatPage}
           cancelRequestButton={handleCancelRequest}
           arriveButton={handleDestinationArrive}
           //goToCallPage={goToCallPage}
          ...
          <View>
            <PinComponent
             visible={showPinModal}
              pinButton={handleConfirmPin}
              //pinValue={handleConfirmPin}
              //handleChangeText={handleConfirmPin}
         ...
         <View>
            <TipModal
             visible={showTip}
             //continueButton={goToRating}
              continueButton={goToCompletePage}
              skipButton={goToCompletePage}
              //value={value}
              //onChangeText={handleChangeText}
          ...
          <View>
            <CompletedModal
             ...
             continueButton={()=> router.navigate('/home')}
             />
          </View>
