...
const CreateAddress = () => {
  ...
  return (
    <SafeAreaView className="bg-white flex-1">
      ...
      >
        <Text className="text-2xl font-psemibold text-black mt-7 ">Add Your Address</Text>
        <Text className="text-sm font-pregular text-black mt-2 ">We need this to help set up your account.</Text>
        ...
        <CustomButton
           ...
           handlePress={()=> router.navigate('/onboardProfile/delivery-type')}
          />
