...
const DeliveryPage = ({
  ...
  const [showFinalCompleted, setShowFinalCompleted] = useState(false);
  ...
  const goToCompletePage = () => {
    setShowTip(false)
    setShowFinalCompleted(true)
  }
  const goToHomePage = () => {
    setShowFinalCompleted(false)
    router.replace('/home')
  }
        ...
        <MapView
         ...
         <View>
            <TipModal
              visible={showTip}
              //continueButton={goToRating}
              handlePressContinue={goToCompletePage}
          ...
          <View>
            <CompletedModal
             visible={showFinalCompleted}
             continueButton={goToHomePage}
             />
          </View>
